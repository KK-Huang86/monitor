...
![Grafana 可以使用 Keycloak 登入](static/imgs/keycloak_SSO1.png)
![Grafana 可以使用 Keycloak 登入](static/imgs/keycloak_SSO2.png)

透過 Keycloak 登入 Grafana，達到 SSO
